        ...
        <div class="card card-custom border-warning">
            ...
            <div class="card-body p-4 text-center">
                <div class="mb-4">
                    ...
                    <h5 class="fw-bold text-dark">¿Está seguro que desea eliminar este baile?</h5>
                ...
                <div class="alert alert-warning alert-custom mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="text-start">
                            ...
                            <p class="mb-0 text-muted">Zona: <?php echo htmlspecialchars($dataToView["data"]["zona"]); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <form class="form" action="index.php?controller=baile&action=delete" method="POST">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-center">
                        ...
                        <a class="btn btn-outline-secondary btn-lg px-4" href="index.php?controller=baile&action=list">
